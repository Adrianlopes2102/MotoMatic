...
export default function Subscription() {
  ...
  const handleSubscribe = async (plan: string, fallbackUrl: string) => {
    ...
    try {
      // Tenta gerar checkout via Edge Function
      const {
        data: { session },
      ...
      if (res.ok) {
        ...
        // Em teste usa sandbox_init_point.
        const url =
            ...
            <Card className="border-2 border-slate-700 bg-slate-800 hover:border-orange-500 transition-all hover:shadow-xl">
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="mt-2 text-slate-400">
                  Ideal para pilotos individuais
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleSubscribe(
                      'pro_piloto',
                      'https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=63f30d0416b84943924a7914a288e6bb'
                    )
                  }
                >
                  {loadingPlan === 'pro_piloto' ? (
          ...
          {(!user || profile?.role === 'mecanico') && (
            <Card className="border-2 border-blue-500 bg-slate-800 hover:border-blue-400 transition-all hover:shadow-xl relative">
              ...
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="mt-2 text-slate-400">
                  Para oficinas e mecânicos profissionais
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleSubscribe(
                      'oficina',
                      'https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=ec3c25dcb840450da01df6329e536804'
                    )
                  }
                >
                  {loadingPlan === 'oficina' ? (
